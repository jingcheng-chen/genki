  ...
  models: [
    {
      id: 'suit',
      label: 'Suit',
      url: '/vrm/mika/models/mika_suit.vrm',
      previewUrl: '/vrm/mika/models/mika_suit.png',
      description: 'sharp DAA dress uniform — formal, on-duty, commander mode',
    },
    {
      id: 'sport',
      label: 'Sport',
      url: '/vrm/mika/models/mika_sport.vrm',
      previewUrl: '/vrm/mika/models/mika_sport.png',
      description: 'athletic gear — casual, off-duty, training or a run',
    },
    {
      id: 'pajama',
      label: 'Pajama',
      url: '/vrm/mika/models/mika_pajama.vrm',
      previewUrl: '/vrm/mika/models/mika_pajama.png',
      description: 'soft sleepwear — late-night, at home, cozy',
    },
  ],
  defaultModelId: 'suit',
